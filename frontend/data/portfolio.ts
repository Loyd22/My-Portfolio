...
export const portfolioData = {
  identity: {
    ...
    headline:
      "Software Developer Intern  |  Data enthusiast  |  Bachelor of Science in Information Technology ",
    rotatingRoles: [
      "AI Engineer Intern",
  ...
  projects: [
    ...
    },
    {
      ...
      repo: "https://github.com/Loyd22/credit-risk-predictor",
      deploymentStatus: "deployed",
      deploymentUrl: "https://loythee-credit-risk-analysis.hf.space/predict"
    },
    {
      title: "PUP Biñan Website",
      summary:
        "A modern university website built to manage institutional content through a CMS-powered admin system. It supports dynamic updates for news, announcements, images, videos, header, and footer content, moving beyond a static website into a more scalable and maintainable platform.",
      highlights: [
        "CMS-driven content management for easier website updates",
        "Admin-controlled sections for header, footer, images, videos, news, and announcements",
        "Database-backed architecture instead of a static site",
        "Built for scalability, maintainability, and easier content operations",
        "Includes data analytics and visualization features for institutional insights"
      ],
      stack: [
        "Next.js",
        "TypeScript",
      ...
      impact:
        "Creates a more professional, maintainable, and scalable web platform for PUP Biñan, with centralized content control and improved digital experience.",
      repo: "https://github.com/Loyd22/PUPBinanWebsite",
      deploymentStatus: "not_deployed",
      previewImage: "/portfolio_image/event4.jpg"
    },
    {
      title: "ML Bulldozer Price Prediction",
      summary:
        "A machine learning project focused on predicting bulldozer sale prices using historical equipment and auction data through an end-to-end regression workflow.",
      highlights: [
        "End-to-end machine learning workflow for tabular regression",
        "Data cleaning and preprocessing for structured equipment sales data",
        "Feature engineering from historical bulldozer and auction records",
        "Model training and evaluation for sale price prediction",
        "Built as a practical portfolio project for applied machine learning"
      ],
      stack: [
        "Python",
        "Jupyter Notebook",
      ...
      impact:
        "Demonstrates practical machine learning skills by solving a real-world price prediction problem, from raw data preparation to predictive modeling and evaluation.",
      repo: "https://github.com/Loyd22/ml-Bulldozer-Price-Prediction",
      deploymentStatus: "not_deployed",
      previewImage: "/portfolio_image/event5.png"
    },
    {
      title: "LabLens-AI",
      summary:
        "An AI-powered web application that analyzes blood chemistry report images, extracts biomarker values, compares them against reference ranges, and generates understandable health insights.",
      highlights: [
        "Upload and analyze blood chemistry report images",
        "Extracts biomarker values from lab report images using AI",
        "Compares results against reference ranges for quick interpretation",
        "Tracks historical lab results and trends over time",
        "Generates personalized lifestyle recommendations with medical disclaimer"
      ],
      stack: [
        "Next.js",
        "GPT-4 Vision",
      ...
      impact:
        "Turns complex lab reports into a more understandable and user-friendly experience by combining image analysis, health data tracking, and AI-powered explanations in one system.",
      repo: "https://github.com/Loyd22/LabLens-AI",
      deploymentStatus: "not_deployed",
      previewImage: "/portfolio_image/event3.jpg"
    },
    {
      title: "Earthquake Fire Prediction ML",
      summary:
        "A machine learning project focused on predicting fire-related risk patterns using earthquake and environmental data through an end-to-end practical ML workflow.",
      highlights: [
        "End-to-end machine learning workflow for disaster-related prediction",
        "Data cleaning and preprocessing for structured environmental and event data",
        "Feature analysis to identify patterns connected to fire risk",
        "Model training and evaluation for predictive performance",
        "Built as a practical project for real-world risk prediction use cases"
      ],
      stack: [
        "Python",
        "Jupyter Notebook",
      ...
      impact:
        "Demonstrates how machine learning can be applied to disaster and risk-related datasets to support data-driven analysis, prediction, and better understanding of possible fire-related outcomes.",
      repo: "https://github.com/Loyd22/Earthquakte_Fire_preds_ML",
      deploymentStatus: "not_deployed",
      previewImage: "/portfolio_image/event2.jpg"
    },
    {
      title: "ML Heart Disease Prediction",
      summary:
        "A machine learning project built to predict the likelihood of heart disease based on patient health-related data through a complete healthcare-focused classification workflow.",
      highlights: [
        "End-to-end machine learning workflow for healthcare classification",
        "Data cleaning and preprocessing of patient health data",
        "Exploratory data analysis to understand patterns and risk factors",
        "Model training and evaluation for heart disease prediction",
        "Built as a practical project for real-world medical prediction use cases"
      ],
      stack: [
        "Python",
        "Jupyter Notebook",
      ...
      impact:
        "Demonstrates how machine learning can be used to support early risk assessment and predictive analysis in healthcare through structured patient data and classification modeling.",
      repo: "https://github.com/Loyd22/ML-heart-disease-prediction",
      deploymentStatus: "not_deployed",
      previewImage: "/portfolio_image/event1.jpg"
    }
  ] as Project[],
  hackathons: [
    {
  ...
  experienceResume: [
    {
      ...
      track: "Developing real-world software experience.",
      year: "Current",
      summary:
        "Building practical experience in chatbot integration, Odoo ERP/CRM automation, backend APIs, and tool-driven workflows while contributing to real client-focused software solutions."
    },
    {
      role: "Bachelor of Science in Information Technology Student",
      track: "Formal IT education with project-first execution",
      year: "2026",
      summary:
        "Growing through formal IT education while applying what I learn to real projects in software development, databases, and AI-driven solutions."
    },
    {
      role: "Hello World",
      track: "Entering the Programming world",
      year: "2022",
      summary:
        "Started my programming journey by learning core development concepts and building small projects that strengthened my problem-solving and coding foundation."
    },
    {
      role: "Service Crew at Mcdonald's",
      track: "real-world work experience",
      year: "2021",
      summary:
        "Gained hands-on experience in customer service, teamwork, communication, and handling fast-paced daily operations in a busy restaurant environment."
    }
  ] as ResumeExperience[],
  recommendations: [
    {
  ...
  gallery: [
    { src: "/portfolio_image/event1.jpg", alt: "Event photo 1" },
    { src: "/portfolio_image/event2.jpg", alt: "Event photo 2" },
    { src: "/portfolio_image/event3.jpg", alt: "Event photo 3" },
    { src: "/portfolio_image/event4.jpg", alt: "Event photo 4" },
    { src: "/portfolio_image/event5.png", alt: "Event photo 5" }
  ],
  learning: [
    {
